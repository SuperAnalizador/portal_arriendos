...
from main.views import home, profile, edit_user, change_password, new_property, create_property, edit_property, delete_property, detail_property
...
urlpatterns = [
    ...
    path('detail_property/<id>', detail_property, name='detail_property'),
